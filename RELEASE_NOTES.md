...
- **Version 1.2.0.** The project now declares `<Version>1.2.0</Version>`, so the executable's assembly, file and product versions read 1.2.0 and the manifest identity matches. Until now the binary carried the SDK default 1.0.0.0 even though the last release was tagged v1.1.0.
